...
az acr import -n $LOGIN_SERVER --source "argoproj/argoexec:$ARGO_VERSION"
az acr import -n $LOGIN_SERVER --source "argoproj/workflow-controller:$ARGO_VERSION"
az acr import -n $LOGIN_SERVER --source "argoproj/argocli:$ARGO_VERSION"
